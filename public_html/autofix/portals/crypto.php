<?php
/**
 * autofix/portals/crypto.php — config del portal crypto.compras24.es para el
...
return [
    'portal_key' => 'crypto',
    'raiz'       => '/home/admin/web/crypto.compras24.es/public_html',
    'state_dir'  => $autofixRoot . '/state/crypto',

    'sources' => [
        ['type' => 'php_generic', 'path' => '/var/log/apache2/domains/crypto.compras24.es.error.log'],
    ],
