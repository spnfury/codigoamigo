<?php 
    ...
    function link_usuario($nombre, $id) {
        return $GLOBALS["website"]."usuario_".strtolower(urlencode($nombre))."_".$id;
    }
    
    function link_usuario_nuevas_marcas($nombre, $id) {
        return $GLOBALS["website"]."usuario_marcas_".strtolower(urlencode($nombre))."_".$id;
    }
    
    
    
    function link_categoria($clave_categoria) {
        return $GLOBALS["website"].$clave_categoria."-comparte-y-gana";
    }
    ...
    function link_listado_categorias () {
        return $GLOBALS["website"]."listado-categorias";
    }
    
    function link_listado_marcas () {
        return $GLOBALS["website"]."listado-marcas";
    }
    
    function link_marca($clave_marca) {
        return $GLOBALS["website"]."de-".$clave_marca;
    }
    
    function link_nuevo_codigo() {
        
        if(!empty($_SESSION["user_id"])) { return $GLOBALS["website"]."nuevo_codigo"; } 
        else { return $GLOBALS["website"]."registro"; }
    ...
    function link_codigo($id_codigo, $clave_marca,$destacado='') {
        ...
        /*}else if (!$_SESSION['user_id'] && $clave_marca!='bookingcom') {
            ...
            return $GLOBALS["website"]."de-".$clave_marca."?codigo=".$id_codigo;
        }
