...
<div class="main_entremedio brand-wrapper">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 mensaje">
                    ...
                    <div class="hero-actions" style="margin-top: 30px;">
                        <a href="#codigos-section" class="btn_codigo_amigo_hero scroll-to-codes" style="padding: 15px 35px; font-size: 1.2rem; border-radius: 50px; text-transform: uppercase; font-weight: 700; box-shadow: 0 10px 20px rgba(0,0,0,0.3); transition: all 0.3s ease;">
                            Ver código amigo <i class="fas fa-chevron-down" style="margin-left: 10px;"></i>
                        </a>
                    </div>
    ...
    .obtener-card { background: linear-gradient(145deg, #1a1a2e, #16213e); border-radius: 20px; border: 1px solid rgba(255,255,255,0.08); overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.5); }
    .obtener-header { padding: 25px 30px 15px; text-align: center; }
    .obtener-header h2 { font-size: 1.5rem; font-weight: 700; color: #fff; margin: 0 0 8px; }
    .obtener-header p { font-size: 0.9rem; color: #9ca3af; margin: 0; }
    /* ── Social Proof Strip ── */
    .social-proof-strip { padding: 0 30px; }
    .social-proof-inner { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.06); border-radius: 14px; padding: 16px 20px; }
    .sp-avatars-row { display: flex; align-items: center; justify-content: center; gap: 0; margin-bottom: 10px; }
    .sp-avatar { width: 38px; height: 38px; border-radius: 50%; object-fit: cover; border: 3px solid #1a1a2e; margin-left: -10px; transition: transform 0.2s; position: relative; z-index: 1; }
    ...
    .sp-avatar-badge { position: absolute; bottom: -4px; right: -4px; font-size: 0.75rem; z-index: 5; line-height: 1; filter: drop-shadow(0 1px 2px rgba(0,0,0,0.5)); }
    .sp-avatar-more { width: 38px; height: 38px; border-radius: 50%; background: rgba(16,185,129,0.2); border: 3px solid #1a1a2e; margin-left: -10px; display: flex; align-items: center; justify-content: center; font-size: 0.75rem; font-weight: 700; color: #10b981; }
    .sp-label { text-align: center; font-size: 0.82rem; color: #9ca3af; margin-bottom: 12px; }
    .sp-label strong { color: #fff; }
    .sp-ticker-wrap { overflow: hidden; height: 32px; position: relative; border-radius: 8px; background: rgba(0,0,0,0.2); }
    ...
    .sp-ticker-name { font-weight: 600; color: #e5e7eb; }
    .sp-ticker-action { color: #6b7280; }
    .sp-ticker-benefit { color: #10b981; font-weight: 600; }
    .sp-ticker-time { color: #4b5563; font-size: 0.75rem; margin-left: auto; }
    ...
    .codigo-valor-container { display: flex; align-items: center; gap: 12px; background: rgba(255,255,255,0.06); border: 2px dashed rgba(16,185,129,0.5); border-radius: 12px; padding: 15px 20px; margin-bottom: 15px; }
    .codigo-valor { flex: 1; font-size: 1.5rem; font-weight: 800; color: #10b981; letter-spacing: 2px; font-family: 'Courier New', monospace; word-break: break-all; }
    .btn-copiar-codigo { background: #10b981; color: #fff; border: none; border-radius: 10px; padding: 10px 20px; font-weight: 600; cursor: pointer; transition: all 0.3s; white-space: nowrap; }
    .btn-copiar-codigo:hover { background: #059669; }
    .btn-copiar-codigo.copied { background: #f59e0b; }
    .codigo-publisher { display: flex; align-items: center; gap: 12px; padding: 12px 0; }
    .publisher-avatar { width: 40px; height: 40px; border-radius: 50%; object-fit: cover; border: 2px solid rgba(255,255,255,0.15); }
    .publisher-info { flex: 1; }
    .publisher-name { font-weight: 600; color: #fff; font-size: 0.9rem; }
    ...
    .trust-premium { background: rgba(245,158,11,0.15); color: #fbbf24; }
    .trust-recommended { background: rgba(16,185,129,0.15); color: #34d399; }
    .trust-trusted { background: rgba(59,130,246,0.15); color: #60a5fa; }
    .trust-verified { background: rgba(107,114,128,0.15); color: #9ca3af; }
    .trust-new { background: rgba(156,163,175,0.1); color: #6b7280; }
    .codigo-descripcion { font-size: 0.85rem; color: #9ca3af; margin-top: 10px; padding: 10px; background: rgba(255,255,255,0.03); border-radius: 8px; }
    /* Vote buttons */
    .vote-buttons-modern { display: flex; align-items: center; gap: 8px; margin-top: 14px; padding: 10px 0; border-top: 1px solid rgba(255,255,255,0.06); }
    .vote-btn-modern { display: inline-flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; padding: 7px 16px; font-size: 0.85rem; font-weight: 600; color: #9ca3af; cursor: pointer; transition: all 0.25s ease; }
    .vote-btn-modern:hover { transform: translateY(-1px); }
    .vote-btn-modern.vote-up:hover, .vote-btn-modern.vote-up.active { background: rgba(16,185,129,0.15); border-color: rgba(16,185,129,0.4); color: #10b981; }
    .vote-btn-modern.vote-down:hover, .vote-btn-modern.vote-down.active { background: rgba(239,68,68,0.15); border-color: rgba(239,68,68,0.4); color: #ef4444; }
    .vote-btn-modern.disabled { opacity: 0.5; pointer-events: none; cursor: default; }
    .vote-btn-modern i { font-size: 0.9rem; }
    .vote-score-modern { font-size: 0.9rem; font-weight: 700; color: #fff; min-width: 20px; text-align: center; }
    ...
    #btnPruebaOtro { background: transparent; border: 1px solid rgba(255,255,255,0.2); color: #9ca3af; border-radius: 25px; padding: 10px 25px; cursor: pointer; font-size: 0.85rem; transition: all 0.3s; }
    #btnPruebaOtro:hover { border-color: #10b981; color: #10b981; }
    #btnVerMas { background: transparent; border: none; color: #60a5fa; font-size: 0.85rem; cursor: pointer; padding: 8px 15px; transition: all 0.3s; }
    #btnVerMas:hover { color: #93c5fd; }
    #verMasLista { display: none; padding: 0 30px 25px; }
    #verMasLista.show { display: block; }
    .ver-mas-item { display: flex; align-items: center; gap: 12px; padding: 12px; background: rgba(255,255,255,0.03); border-radius: 10px; margin-bottom: 8px; transition: all 0.2s; }
    .ver-mas-item:hover { background: rgba(255,255,255,0.06); }
    .ver-mas-avatar { width: 36px; height: 36px; border-radius: 50%; object-fit: cover; }
    .ver-mas-info { flex: 1; }
    .ver-mas-user { font-weight: 600; color: #fff; font-size: 0.85rem; }
    .ver-mas-benefit { font-size: 0.75rem; color: #10b981; font-weight: 500; }
    .ver-mas-trust { margin-top: 3px; }
    .btn-usar-este { background: rgba(16,185,129,0.15); color: #10b981; border: 1px solid rgba(16,185,129,0.3); border-radius: 8px; padding: 6px 14px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.3s; white-space: nowrap; }
    .btn-usar-este:hover { background: #10b981; color: #fff; }
    @media (max-width: 600px) {
