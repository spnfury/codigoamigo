...
<div class="container my-5">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card bg-dark border-orange mb-4">
                <div class="card-body">
                    <h3 class="text-white mb-3">
                        <i class="fas fa-fire text-orange"></i> Promociones Activas
                    </h3>
                    
                    <?php if (empty($promociones_activas)): ?>
                        <p class="text-gray">No tienes promociones activas.</p>
                    <?php else: ?>
            ...
            if (!empty($promociones_expiradas)): 
            ?>
            <div class="card bg-dark border-orange">
                <div class="card-body">
                    <h3 class="text-white mb-3">
                        <i class="fas fa-history text-orange"></i> Promociones Expiradas
                    </h3>
                    <div class="table-responsive">
                        <table class="table table-dark table-sm">
                            ...
                            <tbody>
                                <?php foreach ($promociones_expiradas as $promocion): 
                                    $codigo = getCodeByID($promocion['codigo_id']);
