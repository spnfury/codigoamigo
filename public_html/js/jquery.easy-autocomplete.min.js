		...
		var genericTemplates = {
			...
			convertTemplateToMethod = function (template) {
				...
				if (template.type === 'custom') {
					return function() {
						var res = template.method.apply(this, arguments);
						if (res === false || res === "false" || res === null || typeof res === "undefined") {
							return "";
						}
						return res;
					};
					...
					/* List show animation */
						...
						.on('loadElements.eac', function (event, listBuilders, phrase) {
							...
							for (var builderIndex = 0, listBuildersLength = listBuilders.length; builderIndex < listBuildersLength; builderIndex += 1) {
								...
								// Skip items with empty/false content
								var itemHtml = $item.find(' > div').html();
								if (!itemHtml || itemHtml === '' || itemHtml === 'false') {
									continue;
								}
						...
						// Post-render cleanup: remove any "false" text nodes or li elements
						$elements_container.find('ul li').each(function() {
							var txt = $(this).text().trim();
							if (txt === 'false' || txt === 'False' || txt === 'FALSE') {
								$(this).remove();
							}
						});
						// Remove bare text nodes containing "false" from the container
						$elements_container.find('ul').contents().filter(function() {
