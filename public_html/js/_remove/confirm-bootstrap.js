 ...
 * ========================================================== */
 ...
 (function($) {
    ...
    {
        var body = $('body');
        var id_codigo = $(this).attr('data-id');
        
        var defaultOptions    = {
            confirmTitle     : 'Mensaje de Alerta',
            confirmMessage   : '¿Estás seguro que deseas eliminar este código ?',
            confirmOk        : 'Aceptar',
        ...
        {
        	$.post("/eliminar_codigo", { 'codigo' : id_codigo });
        	location.reload();
        }
    };
})(jQuery);
