<?php
/**
 * Script para crear el Job de comentarios fake en Jenkins
...
$job_name = 'codigoamigo-fake-comments-generation';
...
pipeline {
    ...
    post {
        success {
            echo 'Comments generated successfully!'
        }
        failure {
            echo 'Failed to generate comments.'
        }
    }
}
    </script>
...
echo "  Programado: Cada 6 horas (0 */6 * * *)\n";
