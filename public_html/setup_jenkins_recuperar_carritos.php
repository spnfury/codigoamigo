<?php
/**
 * Script para crear el Job de Recuperación de Carritos VIP en Jenkins
 * Ejecutar UNA VEZ para configurar el job
 * 
 * php setup_jenkins_recuperar_carritos.php
 */

$jenkins_url = 'https://casinovios.com/jenkins';
$jenkins_user = 'spnfury';
$jenkins_token = '11d3122c529524c8a8c85f055ba8ef0311';
$job_name = 'codigoamigo-recuperar-carritos-vip';

$job_config = <<<XML
<?xml version='1.1' encoding='UTF-8'?>
<flow-definition plugin="workflow-job@2.40">
  <description>Revisa sesiones de Checkout de Stripe abandonadas hace más de 2 horas y envía correos automáticos usando Brevo para recuperar los referidos.</description>
...
pipeline {
    ...
    stages {
        stage('Recuperar Carritos VIP') {
            steps {
                script {
                    echo 'Iniciando recuperación de carritos...'
                    sh 'php /home/admin/web/codigoamigo.com/public_html/cron/recuperar_carritos_vip.php 2&gt;&amp;1'
                }
            }
        }
    }
    ...
    post {
        success {
            echo 'Proceso de correos completado correctamente.'
        }
        failure {
            echo 'Error en la recuperación de carritos.'
        }
    }
}
    </script>
...
echo "  Programado: Cada 15 minutos (cron: H/15 * * * *)\n";
