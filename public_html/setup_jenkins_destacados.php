<?php
/**
 * Script para crear el Job de expiración de destacados en Jenkins
 * Ejecutar UNA VEZ para configurar el job inicial
 * 
 * php setup_jenkins_destacados.php
 */

$jenkins_url = 'https://casinovios.com/jenkins';
$jenkins_user = 'spnfury';
$jenkins_token = '11d3122c529524c8a8c85f055ba8ef0311';
$job_name = 'codigoamigo-destacados-expiracion';

$job_config = <<<XML
<?xml version='1.1' encoding='UTF-8'?>
<flow-definition plugin="workflow-job@2.40">
  <description>Gestión diaria de expiración y auto-renovación de códigos destacados. Envía avisos pre-expiración (2 días), notifica expirados, y auto-renueva desde saldo si está activado.</description>
...
pipeline {
    ...
    stages {
        stage('Gestión Destacados Expiración') {
            steps {
                script {
                    echo 'Iniciando gestión de expiración de destacados...'
                    sh 'php /home/admin/web/codigoamigo.com/public_html/cron/cron_destacados_expiracion.php 2&gt;&amp;1'
                }
            }
        }
    }
    ...
    post {
        success {
            echo 'Gestión de destacados completada correctamente.'
        }
        failure {
            echo 'Error en la gestión de destacados.'
        }
    }
}
    </script>
...
echo "  Programado: Diario a las 9am (cron: H 9 * * *)\n";
